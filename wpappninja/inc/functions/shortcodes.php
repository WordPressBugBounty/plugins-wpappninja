...
function wpappninja_show_previous_next($post) {
	...
	if (!empty( $next_post )) { ?>
	<div class="wpmobile-pagination" style="display:none"><a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" class="next"><?php _e('Next', 'wpappninja');?></a>
	</div>
	<?php }
